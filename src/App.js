  ...
  return (
    <div className="app">
      <div className="sidebar">
        ...
        />
        {showFriends && <FormAddFriend onAddFriend={handleAddFriend} />}
        <Button onCLick={handleShowFrienda}>
          {showFriends ? "Close" : "Add"}
        </Button>
      </div>
      {selectedFriend && (
        <FormSplitBill
